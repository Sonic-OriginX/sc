...
contract MockStakingSpectraV2 {
    IERC20 public immutable mockUSDCe;
    ...
    constructor(
        ...
        require(_mockUSDCe != address(0), "Invalid token address");
        mockUSDCe = IERC20(_mockUSDCe);
        owner = msg.sender;
        fixedAPY = _fixedAPY;
    ...
    function stake(uint256 _days, uint256 _amount) external {
        ...
        mockUSDCe.transferFrom(msg.sender, address(this), _amount);
    ...
    function emergencyWithdraw(uint256 _amount) external {
        ...
        mockUSDCe.transfer(msg.sender, finalAmount);
    ...
    function withdraw(uint256 _amount) external {
        ...
        mockUSDCe.transfer(msg.sender, totalToPay);
    ...
    function withdrawToOwner() external {
        ...
        mockUSDCe.transfer(owner, mockUSDCe.balanceOf(address(this)));

        emit WithdrawAll(owner, mockUSDCe.balanceOf(address(this)));
    }
