...
contract MockStakingEulerV2 {
    IERC20 public immutable mockwS;
    ...
    constructor(
        ...
        require(_mockwS != address(0), "Invalid token address");
        mockwS = IERC20(_mockwS);
        owner = msg.sender;
        fixedAPY = _fixedAPY;
    ...
    function stake(uint256 _days, uint256 _amount) external {
        ...
        mockwS.transferFrom(msg.sender, address(this), _amount);
    ...
    function emergencyWithdraw(uint256 _amount) external {
        ...
        mockwS.transfer(msg.sender, finalAmount);
    ...
    function withdraw(uint256 _amount) external {
        ...
        mockwS.transfer(msg.sender, totalToPay);
    ...
    function withdrawToOwner() external {
        ...
        mockwS.transfer(owner, mockwS.balanceOf(address(this)));

        emit WithdrawAll(owner, mockwS.balanceOf(address(this)));
    }
