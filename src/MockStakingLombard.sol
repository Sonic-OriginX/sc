...
contract MockStakingLombard {
    IERC20 public immutable mockLBTC;
    ...
    constructor(
        ...
        require(_mockLBTC != address(0), "Invalid token address");
        mockLBTC = IERC20(_mockLBTC);
        owner = msg.sender;
        fixedAPY = _fixedAPY;
    ...
    function stake(uint256 _days, uint256 _amount) external {
        ...
        mockLBTC.transferFrom(msg.sender, address(this), _amount);
    ...
    function emergencyWithdraw(uint256 _amount) external {
        ...
        mockLBTC.transfer(msg.sender, finalAmount);
    ...
    function withdraw(uint256 _amount) external {
        ...
        mockLBTC.transfer(msg.sender, totalToPay);
    ...
    function withdrawToOwner() external {
        ...
        mockLBTC.transfer(owner, mockLBTC.balanceOf(address(this)));

        emit WithdrawAll(owner, mockLBTC.balanceOf(address(this)));
    }
