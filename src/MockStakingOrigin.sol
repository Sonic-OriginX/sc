...
contract MockStakingOrigin {
    IERC20 public immutable mockOS;
    ...
    constructor(
        ...
        require(_mockOS != address(0), "Invalid token address");
        mockOS = IERC20(_mockOS);
        owner = msg.sender;
        fixedAPY = _fixedAPY;
    ...
    function stake(uint256 _days, uint256 _amount) external {
        ...
        mockOS.transferFrom(msg.sender, address(this), _amount);
    ...
    function emergencyWithdraw(uint256 _amount) external {
        ...
        mockOS.transfer(msg.sender, finalAmount);
    ...
    function withdraw(uint256 _amount) external {
        ...
        mockOS.transfer(msg.sender, totalToPay);
    ...
    function withdrawToOwner() external {
        ...
        mockOS.transfer(owner, mockOS.balanceOf(address(this)));

        emit WithdrawAll(owner, mockOS.balanceOf(address(this)));
    }
