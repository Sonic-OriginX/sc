...
contract MockStakingSiloV2 {
    IERC20 public immutable mockS;
    ...
    constructor(
        ...
        require(_mockS != address(0), "Invalid token address");
        mockS = IERC20(_mockS);
        owner = msg.sender;
        fixedAPY = _fixedAPY;
    ...
    function stake(uint256 _days, uint256 _amount) external {
        ...
        mockS.transferFrom(msg.sender, address(this), _amount);
    ...
    function emergencyWithdraw(uint256 _amount) external {
        ...
        mockS.transfer(msg.sender, finalAmount);
    ...
    function withdraw(uint256 _amount) external {
        ...
        mockS.transfer(msg.sender, totalToPay);
    ...
    function withdrawToOwner() external {
        ...
        mockS.transfer(owner, mockS.balanceOf(address(this)));

        emit WithdrawAll(owner, mockS.balanceOf(address(this)));
    }
